...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"  name = "tt284guestform<?php echo $row["id"]; ?>" >
	...
	<input type="text" name="telephone" id="telephone"   maxlength="12" minlength="4" value="<?php if ($valid){echo htmlspecialchars($row["telephone"]); }else{echo htmlspecialchars($webdata["telephone"]);}?>" onchange="fieldcheck(this.id)">
	<span id="fbtelephone">  </span><?php if (!$valid){echo  $formerror["telephone"]  ;} ?></p>
