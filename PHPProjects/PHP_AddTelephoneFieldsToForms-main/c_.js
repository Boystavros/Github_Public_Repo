...
function fieldcheck(id){  //check if the field represented by the unique identifier id is valid.
   ...
   //test for telephone
    if (id == "telephone"){                           //Allow valid telephone number
      pattern = /^[0-9]{8,10}$/  ;                  // test the value against an appropriate regular expression 
     failmessage ="Only numbers are permitted here";
    } 
...
function validate(){
   ...
   valid = valid && fieldcheck("telephone");
   return valid;
	}
